      ...
      <div className="flex-1 min-w-0 max-w-2xl space-y-6">
          ...
          <CardContent className="space-y-4">
            ...
            >
              <SimpleFormIterator disableReordering disableClear>
                <LocalizedConfigurationLabelInput group="companySectors" />
              </SimpleFormIterator>
            </ArrayInput>
          </CardContent>
        </Card>
        ...
        <Card id="deals">
          <CardContent className="space-y-4">
            ...
            >
              <SimpleFormIterator disableReordering disableClear>
                <LocalizedConfigurationLabelInput group="dealCategories" />
              </SimpleFormIterator>
            </ArrayInput>
          </CardContent>
        </Card>
          ...
          <CardContent className="space-y-4">
            ...
            <ArrayInput source="noteStatuses" label={false} helperText={false}>
              <SimpleFormIterator inline disableReordering disableClear>
                <LocalizedConfigurationLabelInput
                  group="noteStatuses"
                  className="flex-1"
                />
        ...
        <Card id="tasks">
          <CardContent className="space-y-4">
            ...
            <ArrayInput source="taskTypes" label={false} helperText={false}>
              <SimpleFormIterator disableReordering disableClear>
                <LocalizedConfigurationLabelInput group="taskTypes" />
              </SimpleFormIterator>
            </ArrayInput>
          </CardContent>
        </Card>
...
const LocalizedConfigurationLabelInput = ({
  group,
  className,
}: {
  ...
  const labelSource = sourceContext.getSource("label");
  const value = useWatch({ name: valueSource }) ?? "";
  const storedLabel = useWatch({ name: labelSource }) ?? "";
  ...
  return (
    <TextInput
      ...
      parse={(displayedLabel: string) =>
        parseLocalizedConfigurationLabel(
          group,
          { value, label: storedLabel },
          displayedLabel,
          translate,
        )
      }
