...
const CompanyShowContent = () => {
  ...
  const detailQuery = useCustomerDetail(record?.id);
  ...
  return isMobile ? (
    <CompanyShowContentMobile record={record} relatedSummary={relatedSummary} />
  ) : (
    <CompanyShowContentDesktop
      record={record}
...
const CompanyShowContentDesktop = ({
  record,
  relatedSummary,
}: {
  record: Company;
